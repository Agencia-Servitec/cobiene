...
<div class="content-fullscreen" style="text-align:center;">
    <img src="images/logos/icon_coede.png" alt="" style="width:150px;margin:auto;">
    <h2 style="color: black";>COBIENE</h1>
</div>
...
-->
<a href="recreacion.php" class="button button-green button-center button-xs">CIRCULO COBIENE OO.</a>
<a href="tecnicos.php" class="button button-green button-center button-xs">CIRCULO COBIENE Spes. Tco. SO.</a>
</p>
