...
<div class="content-fullscreen" style="text-align:center;">
    <img src="images/pictures/recreacion.png" alt="Circulo cobiene" style="width:150px;margin:auto;">
    <h2 style="color: black";>Círculo de Oficiales</h1>
</div>

<div class="espace">
    <p class="relleno_social">
    Somos una Asociación, creada para brindar bienestar a nuestros asociados y publico en general, ofreciendo una gama de servicios de entretenimiento y recreación para toda la familia, como actividades deportivas, alojamiento, alimentación, peluquería, gimnasio, sauna, así como ambientes para celebraciones y eventos   
    </p>
    <!--<img src="images/pictures/tabla.jfif" alt="" style="width:100%;margin:auto;">-->
        ...
        <div class="secion_slider">
            <div class="container-slider">
               
                <div class="slider" id="slider">
                    <div class="slider__section">
                        <h3 class="sedes" >Arequipa</h3>
                        <img src="images/pictures/arequipa.jpg" alt="" class="slider__img" >
                             
                    </div>
        
                    <div class="slider__section">
                        <h3 class="sedes" >Salaverry</h3>
                        <img src="images/pictures/salaverry.jpg" alt="" class="slider__img">
                    </div>
        
                    <div class="slider__section">
                        <h3 class="sedes" >Chorrillos</h3>
                        <img src="images/pictures/chorrillos.jpg" alt="" class="slider__img">
                    </div>
        
                    <div class="slider__section">
                        <h3 class="sedes" >Tiza</h3>
                        <img src="images/pictures/tiza.jpg" alt="" class="slider__img">
                    </div>

                    <div class="slider__section">
                        <h3 class="sedes" >Ceande</h3>
                        <img src="images/pictures/ceande.jpg" alt="" class="slider__img">
                    </div>

                    <div class="slider__section">
                        <h3 class="sedes" >Piura</h3>
                        <img src="images/pictures/piura.jpg" alt="" class="slider__img">
                    </div>
                </div>
    ...
    <div class="concepto">
        <br><br><p style="font-size:20px; color:black;">Mas Información:</p>
        <div class="enlaces">
            <a rel="nofollow" href="https://circulomilitardelperu.com/index.html" class="link" >
        ...
        <div class="enlaces">
            <a rel="nofollow" href="https://m.facebook.com/circulomilitardelperu/?ref=page_internal" class="link" >
                <img src="images/iconos/facebook.svg" class="icono__">
                circulomilitardelperu
            </a>
        </div>

        <div class="enlaces">
            <a rel="nofollow" href="https://play.google.com/store/apps/details?id=com.circulomilitar.acmp" class="link" >
                <img src="images/iconos/play.svg" class="icono__">
