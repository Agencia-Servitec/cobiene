...
<div class="content-fullscreen" style="text-align:center;">
    ...
    <h1 class="tittle__shadow">SERVICIO SOCIAL</h1>
</div>
<div class="espace">
    ...
    Otorgamiento de ayuda económica social a los familiares directos del personal COBIENE y personal civil, nombrado y contratado en situaciones de actividad con recursos asignados al presupuesto del COBIENE
        ...
        <TABLE BORDER class="__table">
            <TR>
                <TD ROWSPAN=7>AYUDA ECONOMICA</TD>
                <TD>COBERTURA</TD> 
                <TD>ALCANCE</TD> 
            </TR>
            <TR>
                <TD  ROWSPAN=5 class="relleno__table">
                    <b>Rubros</b> <br>
                    <b>Ayuda Economica por Servicio:</b> Pago de sevicios medicos, pago de pensión por enseñanza y terapias, pagos de tratamientos de rehabilitación fisica, psicologica y psiquiatra.
                    <b>Ayuda Economica por Adquisiones:</b> <br>
                    - Adquisición de alimentos: sobre alimentación y suplementos nutricionales <br>
                ...
                <td ROWSPAN=2 style="padding:10px;">Familiares directos del titular (Esposo(A)), hijos y por unica vez a los padres</td> 
            </TR>
    ...
    <div class="concepto">
        ...
        <div class="enlaces">
            <a href="https://www.google.com.pe/maps/place/Cuartel+Gral+Del+Ejercito,+San+Borja+15037/@-12.1007368,-76.9889964,17z/data=!3m1!4b1!4m5!3m4!1s0x9105c7bf511ba59d:0x58c4fae03566984f!8m2!3d-12.1007421!4d-76.9868077?hl=es-419" class="link" >
                <img src="images/iconos/map-pin.svg" class="icono__">
                Av. Boulevard S/N San Borja–Cuartel General
            </a>
        </div>

        <div class="enlaces">
            <a href="tel:+51996370174" class="link" >
                <img src="images/iconos/phone.svg" class="icono__">
                996 370 174 (TCO3 EP ESTEBAN)
            </a>
        </div>

        <div class="enlaces">
            <a href="mailto:das_jbiene@hotmail.com" class="link" >
                <img src="images/iconos/mail.svg" class="icono__">
                das_jbiene@hotmail.com
            </a>
        </div>    
