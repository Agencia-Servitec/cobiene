...
<div class="content-fullscreen" style="text-align:center;">
    <img src="images/pictures/dace.png" alt="" style="width:150px;margin:auto;">
    <h1 class="tittle__shadow">Dace</h1>
</div>

<div class="espace">
    <p class="relleno_social text__responsi">
    El Departamento de Administración de Casas del COBIENE, brinda el servicio de asignación de casas de servicio temporalmente a la familia COBIENE, para lo cual cuenta con las Villas para Oficiales, Técnicos y Sub Oficiales. 
    </p>
    <img src="images/pictures/mapa.png" alt="Mapa" class="img__responsi">
</div>
...
<div class="content-fullscreen">
    ...
    //cambio de id item-buttons_
            <div id="item-buttons">
                ...
                <div id="texto">
                    ...
                    - Deberá encontrar en situación COBIENE de actividad con no mas de 25 años de único como oficial de 28 años para el caso de los teóricos. <br>
                    - Deberá ser casado (a) mantener una relación conyugal estable y vivir con su cónyuge e hijos en la guarnición donde solicita vivienda. <br>
                    - El titular, esposa y familiares directos deberán estar debidamente inscritos en el registro de Familia del COBIENE. <br>
                    - Deberá tener como mínimo cuatro (04) años de servicio cumplido como oficial, en el grado mínimo de teniente y SO2 para el caso de los SSOO. <br>
                    - Deberá prestar servicio en la guarnición donde solicita vivienda. <br>
                    - No debe habar ocupado casa de servicio en los tres (3) últimos años en la guarnición donde se solicita. <br>
                    - No haber sido favorecido con un programa (vivienda/préstamo) del ORES-FOVINE.
                    Acreditara haber devuelto la casa de servicio que haya ocupado en la Guarnición de procedencia.     
    ...
    <div class="concepto">
        <div class="particion">
            ...
            <div class="enlaces">
                ...
                <a href="#" class="link" >
                <img src="images/iconos/map-pin.svg" class="icono__">
                Nuestras Villas <br>en Provincias
                </a>
            </div>
        </div>
            <br>
    ...
    <br>
        ...
        <p id="item-buttons_descarga">
            ...
            <a href="https://drive.google.com/file/d/1BMuifWm1NTDkhUtynifpoRzutQiQ35Uw/view?usp=sharing" class="button button-green button-center button-xs ">           
            Descargar Solicitud
            </a>
           <!-- <a href="http://localhost/Proyectos/cobiene/pdfs/SOLICITUD%20DE%20CASA%202020.pdf" target="_blank" class="button button-green button-center button-xs ">           
            Descargar Solicitud_Local
            </a>-->

           <!-- <iframe src="pdfs/SOLICITUD%20DE%20CASA%202020.pdf" class="button button-green button-center button-xs" style="width:100%; height:700px;" frameborder="0" >
            Descargar Solicitud
            </iframe>-->
        </p>
