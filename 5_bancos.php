...
<div class="content-fullscreen" style="text-align:center;">
    <h1 class="tittle__shadow">BANCOS</h1>
</div>
    ...
    <div class="lista__uni">
            ...
            <div class="universidades item-button item-button" >
                ...
                <p class="relleno__convenios" id="text1" >
                   <B>BENEFICIOS: <BR> </B>
                   TASAS PREFERENCIALES PARA PRESTRAMO POR CONVENIO - COMPRA DE DEUDAS  
                   <br><br> TASAS PREFERENCIALES 12% Y 16%  PARA PRESTAMOS PERSONALES 
                </p>
