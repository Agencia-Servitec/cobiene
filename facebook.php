...
<div class="content-fullscreen" style="text-align:center;">
    <h2 style="color: black";>Noticias</h1>
</div>
...
<iframe id="inlineFrameExample"
    ...
    src="https://www.servitecperu.com/web/inicio.php">
</iframe>

            <!--
            <div class="description">
                    
                <iframe src="" width="100%" height="500" style="border:3px dashed #FFF100;overflow:hidden" 
                scrolling="no"  allowTransparency="true" allow="encrypted-media" data-adapt-container-width="true"></iframe> 
