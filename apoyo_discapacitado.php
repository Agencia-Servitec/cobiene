...
<div class="content-fullscreen" style="text-align:center;">
    ...
    <h2 style="color: black";>APOYO AL DISCAPACITADO</h1>
</div>
<div class="espace">
    <p class="relleno_social">
    La Sección de Apoyo al Personal con Discapacidad y el Centro de Educación Técnica Productiva imparte capacitación en los talleres del <B>CETPRO</B>, al personal en condición de discapacidad
    </p>
   
</div>

    <div class="concepto div__responsive">
        
        <div class="enlaces">
            <a href="https://www.google.com.pe/maps/place/Av+Paseo+de+la+Rep%C3%BAblica+874,+Cercado+de+Lima+15046/@-12.0721923,-77.0334924,17z/data=!3m1!4b1!4m5!3m4!1s0x9105c892e55c8e87:0x722a0796009b84a!8m2!3d-12.0721976!4d-77.0313037?hl=es-419" class="link" >
                <img src="images/iconos/map-pin.svg" class="icono__">Av. Paseo de la Republica N° 874 - Sta. Beatriz LIMA
            </a>
        </div>
        <p class="sad">SAD:</p>
        <div class="enlaces">
            <a href="tel:+51013328109" class="link" >
        ...
        <div class="enlaces">
            <a href="mailto:dapoyo@hotmail.com" class="link" >
                <img src="images/iconos/mail.svg" class="icono__">
                dapoyo@hotmail.com
            </a>
        </div> 
        <p class="sad">CETPRO:</p>
        <div class="enlaces">
            <a href="tel:+51013328108" class="link" >
                <img src="images/iconos/phone.svg" class="icono__">
                013328108
            </a>
        </div>
        ...
        <div class="enlaces">
            <a href="mailto:cetpro8di@Hotmail.com" class="link" >
                <img src="images/iconos/mail.svg" class="icono__">
                cetpro8di@Hotmail.com
            </a>
        </div>        
    </div>
